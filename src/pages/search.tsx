...
const Search = () => {
  ...
  const { isLoading: productLoading, data: searchedData, isError: productIsError, error: productError } = useSearchProductsQuery({ price: maxPrice, page, category, search, sort })
